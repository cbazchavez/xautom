...
# 🧪 Borradores X — 2026-07-06 (calibración de voz)

> Tanda del **2026-07-06**. Una nota por fecha en `Borradores/` (diario de borradores).
> Escritos **a mano** (sin motor) aplicando los moldes de
